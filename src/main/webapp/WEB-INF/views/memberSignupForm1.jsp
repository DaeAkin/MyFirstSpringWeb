...
<html>
    ...
    <table id="memberC">
        ...
        <tr><td>아이디</td> <td><input type="text" id="id" name="id" length="12"  value="${member.id }">   </td></tr>
        <tr><td>닉네임</td> <td><input type="text" id="nickname" name="nickname" length="12" value="${member.nickname }">   </td></tr>
