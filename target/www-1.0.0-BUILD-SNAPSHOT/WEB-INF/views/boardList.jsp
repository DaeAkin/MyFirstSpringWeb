...
<script>
	$(document).ready(function() {
		...
		var pagination = "<nav> <ul class='pagination'> <li><a href='#' aria-label='Previous'> <spanaria-hidden='true'>&laquo;</span></a></li>";
		...
		for(var i = forStart ; i<= forEnd ; i++) {
			if(startPage == i) {
				...
				pagination += '<li><a href="#" name="page_move" start_page="'+i+'" disabled>'+i+'</a></li>';
			} else {
				pagination += '<li><a href="#" name="page_move" start_page="'+i+'">'+i+'</a></li>';
			}
		}
		
		pagination += "<li><a href='#' aria-label='Next'> <span aria-hidden='true'>&raquo;</span></a></li></ul> </nav>";
	...
	<form class="form-inline" id="frmSearch"
		...
		<div class="row">
			<div class="col-md-9 col-sm-4 col-xs-12 gutter">
				<p>
	      <a href="<%=request.getContextPath()%>/board/write"><button type="button" class="btn btn-default">작성하기</button></a>
				</p>
				<div class="sales">
	...
	<%-- <form class="form-inline" id="frmSearch" action="<%=request.getContextPath()%>/board/list">
		...
		<div align="center">
			...
			<table id="board" width="1000px">
				<tr>
					<th width="40px" style="word-break: break-all" align="center">No</th>
					<th width="890px" align="center">제목</th>
					<th width="20px" align="center">작성자</th>
					<th width="50px" align="center">작성일</th>
				</tr>
				<c:choose>
